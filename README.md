...
- текущий активный узкий workstream: `Telegram message format v2`
- остальные улучшения (ignored numbers / owner routing / buttons / poll interval / missed-call filtering) в этот change set не входят

## Telegram message format v2 (активный workstream)
...
- complete and verify `Telegram message format v2` rollout
