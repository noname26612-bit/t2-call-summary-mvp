...
- текущий узкий репозиторный pass: финальное уточнение `Telegram message format v2.1` (separate `Компания/Номер заказа` lines + status-tail cleanup)
...
- deploy final v2.1 refinement to production main app and run one fresh live verification
